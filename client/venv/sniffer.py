...
while(True):
   ...
   # ====alert level 1=======
    ...
    #I need to put the args as variables and not "magical" values (refine the monitor system)
        ...
        os.system('curl http://ac9fbdb6.ngrok.io/alerts -d "callerID=12345" -d "token=token" -d "reason=excessive connections" -d "level=1" -d "callerAddress=someIPPPPPPP" POST -v')
    ...
    if(500<=average<1000):
        ...
        os.system('curl http://ac9fbdb6.ngrok.io/alerts -d "callerID=12345" -d "token=token" -d "reason=excessive connections" -d "level=2" -d "callerAddress=someIPPPPPPP" POST -v')
    ...
    if(1000<average):
        ...
        os.system('curl http://ac9fbdb6.ngrok.io/alerts -d "callerID=12345" -d "token=token" -d "reason=excessive connections" -d "level=3" -d "callerAddress=someIPPPPPPP" POST -v')
